...
module.exports = {
    ...
    async execute(interaction) {
     ...
     if (cropRoll == 1000) {
        ...
        response = 'Today, the Evil Czech crops are: **The Chosen Sailors.**';
    } else if (cropRoll == 235) {
        response = 'Today, the Evil Czech crops are: **Forgiving.**';
    } else if (cropRoll % 4 == 1) {
        response = 'Today, the Evil Czech crops are: **Enemies of the state.**';
    } else if (cropRoll % 4 == 2) {
        response = 'Today, the Evil Czech crops are: **Rising up.**';
    } else if (cropRoll % 4 == 3) {
        response = 'Today, the Evil Czech crops are: **Protesting.**';
    } else {
        response = 'Today, the Evil Czech crops are: **Fraternising.**';
    }
