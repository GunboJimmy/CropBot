...
module.exports = {
    data: new SlashCommandBuilder().setName('evilcripcheck').setDescription('Checks The Evil Crip Crops.'),
    ...
    async execute(interaction) {
     ...
     if (cropRoll == 1000) {
        ...
        response = 'Today, the crip crops are: **Building hospitals.**';
    } else if (cropRoll % 6 == 2) {
        response = 'Today, the crip crops are: **Helping the homeless.**';
    } else if (cropRoll % 6 == 3) {
        response = 'Today, the crip crops are: **Civil servants.**';
    } else if (cropRoll % 6 == 4) {
        response = 'Today, the crip crops are: **Upstanding citizens.**';
    } else if (cropRoll % 6 == 5) {
        response = 'Today, the crip crops are: **Buying cheap shoes from Payless.**';
    } else {
        response = 'Today, the crip crops are: **Dedicated to the betterment of society.**';
    }
